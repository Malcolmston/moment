...
// the GitHub Releases API for malcolmston/moment.
const RELEASE_LIBS: RelLib[] = [
  { name: MOMENT.name, icon: MOMENT.icon, accent: MOMENT.accent, repo: ghrepo(MOMENT), url: MOMENT.repo },
];

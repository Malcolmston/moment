...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/moment', initials: 'mo', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/moment</span> — moment.js-style dates and times, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>Standard-library only · independent re-implementation of moment.js</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/moment" footer={footer}>
